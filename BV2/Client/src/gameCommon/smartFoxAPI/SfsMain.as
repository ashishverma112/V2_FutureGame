package gameCommon.smartFoxAPI 
{
	...
	{
		private var _bns:*;
	    //public static const _serverIp:String = "83.140.191.167"  //password==8vnqbuwY
	    // public static const _serverIp:String = "83.140.191.138"  //password==8vnqbuwY
		...
		public static var _serverIp:String ;	
       //public static const _serverIp:String = "83.140.191.218";	//password==D345$#3Fd
        public static var _serverPort:int;
		...
		public function loadGameConfigXML():void
		{
				
			
            var request:URLRequest = new URLRequest("bingoIP.xml");
			...
			//FileLoader.loadFile("config.xml",xmlLoaded);
		}
		...
		private function loaderCompleteHandler(event:Event):void 
		{
            ...
            try 
			{
                var externalXML:XML = new XML(event.target.data);
				_serverIp = externalXML.serverIp;
				_serverPort = int(externalXML.serverPort);
				initialize()
			}
			catch (e:TypeError)
			{
