package 
{
	...
	import bingoV1.gameScreen.Ball;
	import bingoV1.gameScreen.BingoCard;
	import bingoV1.gameScreen.BingoGameScreen;
	import bingoV1.gameScreen.BingoRoom;
	import bingoV1.gameScreen.BingoUser;
	import bingoV1.gameScreen.Card;

	import bingoV1.gameScreen.CardContainer2;
	import bingoV1.gameScreen.GamePlayScreen;
	import bingoV1.gameScreen.GameTimerScreen;
	import bingoV1.gameScreen.NumberGenerationScreen;
	import bingoV1.gameScreen.PublicChatScreen;
	import bingoV1.gameScreen.RunningText;
	import bingoV1.gameScreen.WinnerScreen;
	import bingoV1.loginScreen.FunLoginScreen;
	//import bingoV1.gameScreen.numberGenerator.NumberGenerator;
	import bingoV1.gameScreen.PatternWinnerScreen;
	...
	import bingoV1.gameScreen.AllWinnerScreen;
	...
	public class Main extends BaseNetworkScreen
	{
		...
		//private static var _mainParent:DisplayObjectContainer;
		...
		static public var isFirstLogin:Boolean = true; 
		private var rm:Room;
	...
	//	var a1:Array = new Array("1", "2", "V", "V");
//trace("jai hind++++++++++++++++++++++++");
			_main = this;
			_currentScreen = this; 
			_languageSet = false; 
		// addChild(new BingoRoom(a1));
	//	 addChild(new CardContainer2(a1));
		//addChild(new AllWinnerScreen(a,a1));
	
	//	
	//_pub:PublicChatScreen = new PublicChatScreen();
	//addChild(_pub)
		
		//addChild(ul);
		//ul.addUsers(arr);
//addChild(new RunningText("jai ho"));
//	addChild(new PublicChatScreen());
	BallResources.initialize(); 
	//addChild(new NumberGenerationScreen());
		
			//trace ("here setting _languageset");
			
			//addChild(new MovingBall(10));
		...
		override public function resizeScreen():void
		{
			...
			//	screenUI.loginMain.width = 384;
			 //   screenUI.loginMain.height = 333;
			}
		...
		override public function onExtensionResponse(event:SFSEvent):void
		{
			...
			if (result[0] == ServerConstants.LOGIN_MESSAGE)
			{
				...
				else
				{
					_languageSet = true;
					trace("",result[2])
					var errorScreen:ErrorLoginScreen = new ErrorLoginScreen(int(result[2]));
		...
		static public function setMainLobbyScreen(oldScreen:BaseNetworkScreen,jdf:Boolean = true):void
		{
