package bingoV1.gameScreen 
{
	...
	public class SoundScreen extends BaseScreen
	{
		...
		override public function initialize():void
		{
			...
			addGameEventListener(screenUI.music2, MouseEvent.CLICK, setBackgroundMusic);
			//setTimer();
			setSoundButton();
			setVolumeSlider();
		...
		public function setBackgroundMusic(evt:MouseEvent):void
		{
			
				//trace("kyu ho rha h")
				SoundPlayer.backgroundSound(evt);
			    setSound2Button();
			
		}
		public function setSound2Button():void
		{
			//trace("jyua ",SoundPlayer._introMuted)
			if (SoundPlayer._introMuted)
				screenUI.music2.gotoAndStop(2);
			else
				screenUI.music2.gotoAndStop(1);
		}
