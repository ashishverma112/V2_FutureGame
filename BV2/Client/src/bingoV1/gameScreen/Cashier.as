package bingoV1.gameScreen 
{
	...
	public class Cashier extends BaseScreen
	{
		...
		public function sendGetRequest():void
		{
			...
			var url:String = GetDisplayObject.getBalanceRequestURL() + "/BalanceRequest?client_session_id=550.00&gameid=BingoV2_Duch&username=" + Main._userName + "&password=" +Main._password+"&random="+ Math.random();
		...
		private function loaderCompleteHandler(e:Event):void
		{
			 ...
			 if ( response.child("error_code")[0].toString() == "0")
			{
				...
				_balance = (balance/100 + Number(_Screen.totalbalance.text)).toFixed(2);
				
				trace("balance is now+++++++++++++++++++++++++++++", _balance );
				_Screen.totalbalance.text=_balance;
			}
		}
